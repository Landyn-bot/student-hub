...
export const SYSTEM_PROMPT = [
  ...
  "",
  "Rules:",
  '- "deadline": anything a student must hand in, complete, read or attend on a date: assignments, quizzes, projects, labs, readings, discussion posts, in-class activities.',
  "  A row of a schedule table that carries a date is a deadline. Give it that exact date, and pick the subtype from what the row says to do.",
  '- "exam": scheduled exams, midterms and finals (a quiz that is a graded assignment is a deadline).',
  '- "class_meeting": ONLY a session that repeats every week all term, stated as a weekly pattern with no calendar date (e.g. "Lecture: TuTh 1:00PM-2:15PM", "Lab 1020: W 1:00-2:50PM").',
  "  If the excerpt gives a specific calendar date for a session, it is NOT a class_meeting — record it as a deadline with that date.",
