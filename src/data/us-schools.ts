// Static list of U.S. colleges and universities used for the school autocomplete.
// Bundled locally so onboarding works without any network call.
export const usSchools: readonly string[] = [
  "42 US",
  "ASA College",
